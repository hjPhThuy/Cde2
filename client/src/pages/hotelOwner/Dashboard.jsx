...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Bảng điều kiển' subTitle={`Theo dõi danh sách phòng, theo dõi đặt phòng và phân tích doanh thu - tất cả tại một nơi. Luôn cập nhật thông tin chi tiết theo thời gian thực để đảm bảo hoạt động trơn tru.`}/>
        ...
        <div className='flex gap-4 my-8'>
            ...
            pr-8'>
                ...
                <div className='flex flex-col sm:ml-4 font-medium'>
                    ...
                    <p className='text-neutral-400 text-base'>{dashboardData.totalBookings} VND</p>
                </div>
            </div>
            {/**----Total revenue-- */}
            <div className='bg-primary/3 border border-primary/10 rounded flex p-4
