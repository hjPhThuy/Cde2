    ...
    <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4'>
                ...
                <input type="text" placeholder="Nhập tên khách sạn" className="border border-gray-200
            ...
            <div className='w-full mt-4'>
                ...
                <input id='contact' type="text" placeholder="(+84)" className="border border-gray-200
                rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required/>
            </div>
            {/** Address */}
            <div className='w-full mt-4'>
                <label htmlFor='address' className="font-medium text-gray-500">Địa chỉ</label>
                <input id='Address' type="text" placeholder="Nhập địa chỉ" className="border border-gray-200
                rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required/>
            </div>
